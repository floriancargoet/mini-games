var Utils = (function () {
  ...
  function makeSound(soundArray) {
    return jsfxlib.createWave(soundArray);
  }

  function makeSoundPool(soundArray, size) {
    var sound = makeSound(soundArray);
    var pool = [sound];
